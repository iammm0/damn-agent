...
- [OpenAI Evals Repository](https://github.com/openai/evals)：构建和复用模型评测样例的开源参考。
- [LlamaIndex Evaluation Documentation](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/)：RAG 与问答评测维度参考。
- [NIST AI Risk Management Framework](https://www.nist.gov/itl/ai-risk-management-framework)：高风险 AI 系统治理和风险管理参考。
