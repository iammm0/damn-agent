...
description: 智能体学习地图的阅读方式、内容边界和推荐路径。
---
...
1. 先读 [智能体学习路线](/docs/roadmap)。
2. 再读 [Agent Loop](/docs/concepts/agent-loop)。
3. 接着读 [工具调用与记忆](/docs/concepts/tools-and-memory)。
4. 进入 [上下文工程](/docs/practices/context-engineering) 和 [评测与回归](/docs/practices/evaluation)。
5. 最后选择框架和案例做实作。
