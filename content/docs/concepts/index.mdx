...
- [ReAct](https://arxiv.org/abs/2210.03629)：推理与行动交替的 Agent Loop 来源。
- [Toolformer](https://arxiv.org/abs/2302.04761)：模型学习调用外部工具的代表性研究。
- [MRKL Systems](https://arxiv.org/abs/2205.00445)：语言模型与外部模块组合的系统架构。
- [Model Context Protocol Documentation](https://modelcontextprotocol.io/)：工具、资源和提示的标准化接入协议。
- [智能体基础](/docs/concepts/agentic-basics)：本站对书籍和论文来源的综合入口。
