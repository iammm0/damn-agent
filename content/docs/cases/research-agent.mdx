...
- [Retrieval-Augmented Generation for Knowledge-Intensive NLP Tasks](https://arxiv.org/abs/2005.11401)：RAG 思路的代表性论文。
- [GPT Researcher Repository](https://github.com/assafelovic/gpt-researcher)：研究型 Agent 的开源实现参考。
- [OpenAI Cookbook: Question answering using embeddings](https://cookbook.openai.com/examples/question_answering_using_embeddings)：基于检索和引用的问答实现参考。
