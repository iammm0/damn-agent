...
| 协作者 | GitHub ID | 微信号 | 负责板块 | Todo 编号 | 状态 | 本次更新 | 证据 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 排期者 | @iammm0 | 待补充 | 项目排期与发布 | - | 已发布 | 去掉站点 Beta 口径，版本号改为 `0.2.0` | `lib/site.ts`、`content/docs/index.mdx` |

### 内容更新

- 首页、README、页面元数据不再把文档站写成 Beta。
- 更新记录补充结束 Beta 口径的条目；2026-06-13 的 Beta 发布记录保留为历史。

### 工程更新

- `package.json`、`lib/site.ts` 版本号改为 `0.2.0`。
- 站点品牌组件不再展示 Beta 标识。
...
- 扩写编程语言基础板块：补充 TypeScript、Python、Go、Rust 的基础特性、高级特性、Agent 工程边界和官方延伸阅读，并新增 Node.js 与 TypeScript 生态页。
